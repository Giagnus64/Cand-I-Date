...
Stance.create(politician_id:besa.id, issue_id:cor.id, support: true)
Stance.create(politician_id:besa.id, issue_id:imp.id, support: true)
=begin
#Cory Booker
...
Stance.create(politician_id:cobo.id, issue_id:gun.id, support: true)
...
#Michael Crapo
Stance.create(politician_id:micr.id, issue_id:abo.id, support: true)
Stance.create(politician_id:micr.id, issue_id:imm.id, support: true)
Stance.create(politician_id:micr.id, issue_id:gun.id, support: true)
Stance.create(politician_id:micr.id, issue_id:mar.id, support: true)
Stance.create(politician_id:micr.id, issue_id:cli.id, support: true)
Stance.create(politician_id:micr.id, issue_id:hea.id, support: true)
...
#Ted Cruz
Stance.create(politician_id:tecr.id, issue_id:abo.id, support: true)
Stance.create(politician_id:tecr.id, issue_id:imm.id, support: true)
Stance.create(politician_id:tecr.id, issue_id:gun.id, support: true)
Stance.create(politician_id:tecr.id, issue_id:mar.id, support: true)
Stance.create(politician_id:tecr.id, issue_id:cli.id, support: true)
Stance.create(politician_id:tecr.id, issue_id:hea.id, support: true)
...
Stance.create(politician_id:kigi.id, issue_id:cor.id, support: true)
Stance.create(politician_id:kigi.id, issue_id:imp.id, support: true)
    
#Lindsey Graham
Stance.create(politician_id:ligr.id, issue_id:abo.id, support: true)
Stance.create(politician_id:ligr.id, issue_id:imm.id, support: true)
Stance.create(politician_id:ligr.id, issue_id:gun.id, support: true)
Stance.create(politician_id:ligr.id, issue_id:mar.id, support: true)
Stance.create(politician_id:ligr.id, issue_id:cli.id, support: true)
Stance.create(politician_id:ligr.id, issue_id:hea.id, support: true)
...
Stance.create(politician_id:kaha.id, issue_id:imm.id, support: true)
...
#Mitch McConnell
Stance.create(politician_id:mimc.id, issue_id:abo.id, support: true)
Stance.create(politician_id:mimc.id, issue_id:imm.id, support: true)
Stance.create(politician_id:mimc.id, issue_id:gun.id, support: true)
Stance.create(politician_id:mimc.id, issue_id:mar.id, support: true)
Stance.create(politician_id:mimc.id, issue_id:cli.id, support: true)
Stance.create(politician_id:mimc.id, issue_id:hea.id, support: true)
...
#Mitt Romney
Stance.create(politician_id:miro.id, issue_id:abo.id, support: true)
Stance.create(politician_id:miro.id, issue_id:imm.id, support: true)
Stance.create(politician_id:miro.id, issue_id:gun.id, support: true)
Stance.create(politician_id:miro.id, issue_id:mar.id, support: true)
Stance.create(politician_id:miro.id, issue_id:cli.id, support: true)
Stance.create(politician_id:miro.id, issue_id:hea.id, support: true)
...
Stance.create(politician_id:elwa.id, issue_id:cor.id, support: true)
Stance.create(politician_id:elwa.id, issue_id:imp.id, support: true)
...
Stance.create(politician_id:joca.id, issue_id:gun.id, support: true)
...
#Liz Cheney
Stance.create(politician_id:lich.id, issue_id:abo.id, support: true)
Stance.create(politician_id:lich.id, issue_id:imm.id, support: true)
Stance.create(politician_id:lich.id, issue_id:gun.id, support: true)
Stance.create(politician_id:lich.id, issue_id:mar.id, support: true)
Stance.create(politician_id:lich.id, issue_id:cli.id, support: true)
Stance.create(politician_id:lich.id, issue_id:hea.id, support: true)
...
Stance.create(politician_id:tuga.id, issue_id:cor.id, support: true)
Stance.create(politician_id:tuga.id, issue_id:imp.id, support: true)
    
#Barry Loudermilk
Stance.create(politician_id:balo.id, issue_id:abo.id, support: true)
Stance.create(politician_id:balo.id, issue_id:imm.id, support: true)
Stance.create(politician_id:balo.id, issue_id:gun.id, support: true)
Stance.create(politician_id:balo.id, issue_id:mar.id, support: true)
Stance.create(politician_id:balo.id, issue_id:cli.id, support: true)
Stance.create(politician_id:balo.id, issue_id:hea.id, support: true)
Stance.create(politician_id:balo.id, issue_id:cor.id, support: true)
Stance.create(politician_id:balo.id, issue_id:imp.id, support: true)
    
#Kevin McCarthy
Stance.create(politician_id:kemc.id, issue_id:abo.id, support: true)
Stance.create(politician_id:kemc.id, issue_id:imm.id, support: true)
Stance.create(politician_id:kemc.id, issue_id:gun.id, support: true)
Stance.create(politician_id:kemc.id, issue_id:mar.id, support: true)
Stance.create(politician_id:kemc.id, issue_id:cli.id, support: true)
Stance.create(politician_id:kemc.id, issue_id:hea.id, support: true)
...
Stance.create(politician_id:aloc.id, issue_id:cor.id, support: true)
Stance.create(politician_id:aloc.id, issue_id:imp.id, support: true)
...
Stance.create(politician_id:ilom.id, issue_id:cor.id, support: true)
Stance.create(politician_id:ilom.id, issue_id:imp.id, support: true)
    
#Steve Scalise
Stance.create(politician_id:stsc.id, issue_id:abo.id, support: true)
Stance.create(politician_id:stsc.id, issue_id:imm.id, support: true)
Stance.create(politician_id:stsc.id, issue_id:gun.id, support: true)
Stance.create(politician_id:stsc.id, issue_id:mar.id, support: true)
Stance.create(politician_id:stsc.id, issue_id:cli.id, support: true)
Stance.create(politician_id:stsc.id, issue_id:hea.id, support: true)
...
#Lloyd Smucker
Stance.create(politician_id:llsm.id, issue_id:abo.id, support: true)
Stance.create(politician_id:llsm.id, issue_id:imm.id, support: true)
Stance.create(politician_id:llsm.id, issue_id:gun.id, support: true)
Stance.create(politician_id:llsm.id, issue_id:mar.id, support: true)
Stance.create(politician_id:llsm.id, issue_id:cli.id, support: true)
Stance.create(politician_id:llsm.id, issue_id:hea.id, support: true)
...
Stance.create(politician_id:ratl.id, issue_id:cor.id, support: true)
Stance.create(politician_id:ratl.id, issue_id:imp.id, support: true)
